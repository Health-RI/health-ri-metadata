...
Finally, the newly introduced property data origin (`efo:EFO_0022043`), with the goal to discriminate non-synthetic from synthetic data, is included in this version 2 of the Health-RI core metadata schema. We now propose to further indicate the **nature of the data** (e.g. whole genome sequencing data, or questionnaire data) with `healthdcatap:healthTheme`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [contact point](https://www.w3.org/TR/vocab-dcat-3/#Property:resource_contact_point) | Relevant contact information for the cataloged resource. | `dcat:contactPoint` | NA | `vcard:Kind` | A contact point is someone who can answer questions about the catalogue. Example: Data Manager/Steward. Additional properties for the contact point can be found in the class Kind. | 1 | TBD |
