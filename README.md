...
| [publisher](http://purl.org/dc/terms/publisher) | An entity responsible for making the resource available. | `dct:publisher` | NA | `foaf:Agent` | The organisation making the dataset series available. The publisher of the dataset series may not be the same as the publisher of the individual datasets within the series. | 0..1 |
...
| [identifier](http://purl.org/dc/terms/identifier) | A unique identifier of the agent. | `dct:identifier` | ROR: <https://ror.org/> <br> ISNI: <https://isni.org/page/search-database/> <br> TOOI: <https://standaarden.overheid.nl/tooi/waardelijsten/> <br> Wikidata: <https://www.wikidata.org/> <br> ORCID: <https://orcid.org/> | `rdfs:Literal` | Specify the entity (person or organisation) by providing an identifier. We recommend using a ROR identifier for an organisation. Dutch governmental organisations are listed in TOOI. If these are not available, you can use ISNI, or Wikidata or any other identifier you may have. In case you are referring to a person, use ORCID: <https://orcid.org/>. If you have multiple identifiers, you should provide them all. | 1..\* |
