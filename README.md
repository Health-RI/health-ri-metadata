...
<img align="left" src="Images\HRI-Prim-2023_RGB-small.jpg" alt="Health-RI Core metadata schema" width="300"/><br>
...
<br><br>SHACL shapes corresponding to the latest version of the model can be found: [Shacl shapes](https://github.com/Health-RI/health-ri-metadata/tree/master/Formalisation(shacl)/Core).
