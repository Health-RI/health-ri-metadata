...
<br>SHACL shapes corresponding to the latest version of the model can be found: [Shacl](https://github.com/Health-RI/health-ri-metadata/tree/master/Formalisation(shacl)/Core).
