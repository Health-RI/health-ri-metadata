...
Please note: this GitHub page is about the Health-RI metadata model. If you have a question or an issue with the implementation of FAIR Data Points, please contact onboarding@health-ri.nl. 
...
## I Have a Question
If you want to ask a general question and the [technical documentation](https://health-ri.github.io/metadata-documentation/) or [Onboarding documentation](https://health-ri.atlassian.net/wiki/spaces/FSD/pages/279150593/Metadata+onboarding+on+the+National+Catalogue?atlOrigin=eyJpIjoiZTc2OTU4ZDAwNDAyNGY5Yzk0NzdmMTJhOTkyODcyNDAiLCJwIjoiYyJ9) does not answer it, please direct your question to onboarding@health-ri.nl.
...
- Determine if your bug is really a bug and not an error on your side, e.g., by using incompatible environment
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check whether there is already an existing bug report for your bug or error in the [bug tracker](https://github.com/Health-RI/health-ri-metadata/issues).
...
You must never report security-related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to onboarding@health-ri.nl.
...
If you would like to be a part of the Health-RI core modeling group, please contact onboarding@health-ri.nl. Please provide information on who you are, which node you are from and what experience you have with modeling and we will get back to you with more information.
